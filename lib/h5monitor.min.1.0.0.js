(function (global, factory) {
	...
	(global = global || self, global.H5monitor = factory());
	...
	function u(a){if(!(a instanceof Array)){a=t(a);for(var b,c=[];!(b=a.next()).done;){ c.push(b.value); }a=c;}return a}var v=0;function w(a,b){var c=XMLHttpRequest.prototype.send,d=v++;XMLHttpRequest.prototype.send=function(f){
	var arguments$1 = arguments;
	for(var e=[],g=0;g<arguments.length;++g){ e[g-0]=arguments$1[g]; }var E=this;a(d);this.addEventListener("readystatechange",function(){4===E.readyState&&b(d);});return c.apply(this,e)};}
	function x(a,b){var c=fetch;fetch=function(d){
	var arguments$1 = arguments;
	for(var f=[],e=0;e<arguments.length;++e){ f[e-0]=arguments$1[e]; }return new Promise(function(d,e){var g=v++;a(g);c.apply(null,[].concat(u(f))).then(function(a){b(g);d(a);},function(a){b(a);e(a);});})};}var y="img script iframe link audio video source".split(" ");function z(a,b){a=t(a);for(var c=a.next();!c.done;c=a.next()){ if(c=c.value,b.includes(c.nodeName.toLowerCase())||z(c.children,b)){ return !0; } }return !1}
	 ...
	 * @LastEditTime 2020-06-08 00:46:47
	 */
	var tracker = {
	    a: "trs",
	};
	for (var i = 0, list = [1, 3, 3]; i < list.length; i += 1) {
	    var item = list[i];
...
//# sourceMappingURL=h5monitor.min.1.0.0.js.map
